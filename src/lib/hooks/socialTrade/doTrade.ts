...
import { getAbiURL, getOldInputs, getReciept, makeCallData, sendTx } from "./utils";
...
export const getMethodDataFromTx2 = async (signer: any, txHash: any, reciept: any) => {

    console.log('event-toHex', reciept, BigNumber.from(reciept.transactionIndex).toHexString());
